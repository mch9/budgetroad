      ...
      <div className="-mx-6 flex gap-4 overflow-x-auto px-6 pb-2 sm:mx-0 sm:grid sm:grid-cols-5 sm:overflow-visible sm:px-0">
        {PERSONAS.map((p, i) => (
          <Reveal key={p.f} delay={i * 60} className="shrink-0">
            <div className="group flex h-full w-40 flex-col items-center rounded-2xl border border-[#373737]/10 bg-white/50 p-5 transition-colors hover:border-[#AAC7E1] sm:w-auto">
